...
echo "warp"
cmtk warp --nmi --verbose-level 6 --energy-weight 1e-1 --exploration 4 --fast --accuracy 0.5 --grid-spacing 32 --refine 3 --output-intermediate -o $RESULT_PATH/warp.list $REF_PATH $IMG_PATH $RESULT_PATH/affine.list
